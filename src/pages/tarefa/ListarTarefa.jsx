...
const initialRows = [
  createData(1, 'Matemática', 'Geometria', '2024-01-01', '2024-01-02', 'Concluída', 'SIM'),
  createData(2, 'Física', 'Termodinâmica', '2024-01-03', '2024-01-04', 'Em Andamento', 'NÃO '),
  createData(3, 'Química', 'Tabela periódica', '2024-01-04', '2024-01-05', 'Em Andamento', 'NÃO'),
  createData(4, 'Geografia', 'Cartografia', '2024-01-05', '2024-01-06', 'Em Andamento', 'NÃO'),
  createData(5, 'Biologia', 'Anatomia', '2024-01-06', '2024-01-07', 'Em Andamento', 'NÃO'),
  createData(6, 'Português', 'Ortografia', '2024-01-07', '2024-01-08', 'Concluída', 'SIM'),
  createData(7, 'História', 'Idade Média', '2024-01-07', '2024-01-08', 'Em Andamento', 'NÃO'),
];
...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        ...
        <CardContent>
            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                ...
                <TableRow>
                    ...
                    <TableCell align="right">Descrição da Matéria</TableCell>
                    <TableCell align="right">Data de Início</TableCell>
                    <TableCell align="right">Data de Finalização</TableCell>
                    <TableCell align="right">Status</TableCell>
                    <TableCell align="right">Resumida</TableCell>
        ...
        <CardActions>
            <Button size="small" variant="contained" onClick={handleOpen}>Adicionar Matéria</Button>
